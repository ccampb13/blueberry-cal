...
RSpec.describe Month do
  context ".header" do
    it "matches cal for December 2012" do
      ...
      month.header.should == "  Decebmer 2012"
    end
  ...
  context ".name" do
    it "translates January" do
      Month.new(01,2012).name.should == "January"
    end
    it "translates Febraury" do
      Month.new(02,2012).name.should == "February"
    end
    it "translates March" do
      Month.new(03,2012).name.should == "March"
    end
    it "translates April" do
      Month.new(04,2012).name.should == "April"
    end
    it "translates May" do
      Month.new(05,2012).name.should == "May"
    end
    it "translates June" do
      Month.new(06,2012).name.should == "June"
    end
    it "translates July" do
      Month.new(07,2012).name.should == "July"
    end
